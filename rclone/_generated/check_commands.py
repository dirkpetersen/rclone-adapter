...
class CheckOptions(BaseModel):
    ...
    one_way: bool = Field(
        False, description="Check one way only, source files must exist on remote"
    )
...
class HashsumOptions(BaseModel):
    ...
    output_file: bool = Field(
        False, description="string   Output hashsums to a file rather than the terminal"
    )
